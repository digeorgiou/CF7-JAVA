...
public class LottoExcercise {

/**    Lotto App Εξάδες 1 - 49 με φίλτρα Ζητήστε από τον χρήστη να εισάγει
 * έξι ακεραίους από 1 έως 49 και ελέγξτε
αν αυτή η εξάδα περνάει από τα παρακάτω φίλτρα (predicates)
